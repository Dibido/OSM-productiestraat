...
public:
	 ...
	 * @param io_service
	 */
	 //cppcheck-suppress explicitConstructor
...
public:
	 ...
	 */
	// cppcheck-suppress passedByValue
	ClientSession(Message aMessage, boost::asio::io_service& io_service,
			// cppcheck-suppress passedByValue
			ResponseHandlerPtr aResponseHandler) :
			Session(io_service), message(aMessage), responseHandler(
					aResponseHandler)
	{
	}
	/**
